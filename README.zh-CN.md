...
可用 `alphasift strategies --json` 或 `alphasift strategies --explain` 查看策略数据依赖、活跃硬筛、因子权重和 profile 覆盖项。在 `strategies/` 目录添加 YAML 文件即可。参考 [docs/strategy-guide.md](docs/strategy-guide.md)。
